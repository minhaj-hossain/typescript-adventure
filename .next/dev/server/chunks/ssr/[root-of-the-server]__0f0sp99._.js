module.exports = [
"[project]/src/curriculum.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/data/solutions.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LEVEL_SOLUTIONS = {
    ...
    "level-5-7-satisfies-operator": {
        explanation: "The 'satisfies' operator allows you to pre-validate that a specific value conforms to an interface or broader contract while letting TypeScript retain the narrowest, most specific literal type inferred for that value.",
        steps: [
            "Define the 'routerConfig' object literal containing route paths and roles.",
            "Append 'satisfies Record<string, RouteConfig>' to the end of the object declaration.",
            "This ensures all keys conform to RouteConfig without widening the keys themselves to general strings."
        ],
        codeExample: `const routerConfig = {\n  home: { path: "/", requiresAuth: false },\n  dashboard: { path: "/dashboard", requiresAuth: true }\n} satisfies Record<string, RouteConfig>;`,
        codeTip: "Using ': Record<string, RouteConfig>' causes TypeScript to broaden keys, breaking downstream autocomplete for specific route names like 'home' and 'dashboard'. Use 'satisfies' to prevent this widening."
    },
    "level-6-1-conditional-types": {
    ...
    "level-6-4-utility-extraction": {
        explanation: "The built-in 'Parameters<T>' and 'ReturnType<T>' utility types extract parameters and return types from a function type definition dynamically.",
        steps: [
            "Use 'typeof legacyBookEvent' to obtain the type signature of the function.",
            "Wrap this inside 'Parameters<typeof legacyBookEvent>' to capture the parameter types as a tuple type.",
            "Wrap this inside 'ReturnType<typeof legacyBookEvent>' to capture the function's returned object shape dynamically."
        ],
        codeExample: `type LegacyParams = Parameters<typeof legacyBookEvent>;\ntype LegacyResult = ReturnType<typeof legacyBookEvent>;`,
        codeTip: "Using these built-in utilities avoids duplicate declarations and keeps your wrappers automatically updated when third-party libraries change signatures."
    },
    "level-7-1-ambient-declarations": {
    ...
    "level-8-1-express-routes": {
        explanation: "Express's Request type accepts generic arguments, allowing you to enforce static types on request parameters, bodies, queries, and other properties. Providing '<{ id: string }>' to Request types 'req.params.id' as a string.",
        steps: [
            "Import Request and Response from 'express'.",
            "Type the 'req' parameter as 'Request<{ id: string }>' to enforce the 'id' route parameter contract.",
            "Type the 'res' parameter as 'Response'."
        ],
        codeExample: `import { Request, Response } from "express";\n\napp.get("/events/:id", (req: Request<{ id: string }>, res: Response) => {\n  const id = req.params.id;\n  res.json(findEventById(events, id));\n});`,
        codeTip: "The first generic parameter of Express's Request type specifically defines the route path parameters object."
    },
    "level-8-2-mongo-document-contract": {
        explanation: "The native MongoDB driver supports strongly typed collections using the Collection<T> generic. At rest, _id is stored as an ObjectId, so incoming query parameters (which are strings) must be explicitly cast to ObjectId.",
        steps: [
            "Import Collection and ObjectId from 'mongodb'.",
            "Declare the EventDocument interface with an '_id' field of type ObjectId.",
            "Type 'eventsCollection' as 'Collection<EventDocument>'.",
            "Instantiate 'new ObjectId(id)' to safely convert the incoming route parameter into the required ObjectId query format."
        ],
        codeExample: `import { Collection, ObjectId } from "mongodb";\n\ninterface EventDocument {\n  _id: ObjectId;\n  title: string;\n  date: string;\n  capacity: number;\n}\n\nconst eventsCollection: Collection<EventDocument> = db.collection("events");\n\nasync function getEvent(id: string) {\n  return eventsCollection.findOne({ _id: new ObjectId(id) });\n}`,
        codeTip: "By default, querying ObjectId fields in MongoDB with plain string values returns null without any warning. This makes static Document Contracts essential."
    },
    "level-8-3-request-augmentation": {
        explanation: "Express types are global and ambient, meaning they can be customized using Declaration Merging. Inside a 'declare global' block, you can open the 'Express' namespace and merge properties onto the 'Request' interface directly.",
        steps: [
            "Declare the AuthUser interface with 'id' and 'role' properties.",
            "Open a 'declare global' block, declare the 'Express' namespace inside it, and open the 'Request' interface.",
            "Add an optional 'user?: AuthUser' property onto the 'Request' interface so it is available across all route handler files."
        ],
        codeExample: `import { Request, Response, NextFunction } from "express";\n\ninterface AuthUser {\n  id: string;\n  role: "admin" | "organizer" | "attendee";\n}\n\ndeclare global {\n  namespace Express {\n    interface Request {\n      user?: AuthUser;\n    }\n  }\n}\n\nfunction requireAuth(req: Request, res: Response, next: NextFunction) {\n  req.user = decodeToken(req.headers.authorization);\n  next();\n}\n\napp.get("/me", (req: Request, res: Response) => {\n  res.json(req.user);\n});`,
        codeTip: "Declaration Merging appends fields into existing interfaces instead of replacing them, allowing third-party request context helpers to type-check natively."
    },
    "level-8-4-better-auth-jwt": {
        explanation: "Exposing raw JWT payloads typed as 'any' leads to unsafe property operations downstream. By wrapping verification in a Try/Catch block that maps errors to a typed Discriminated Union, we achieve 100% type safety.",
        steps: [
            "Define the SessionPayload interface to strictly model the fields inside the JWT payload.",
            "Establish the 'VerifyResult' union with a 'valid: true' success variant and a 'valid: false' reason variant.",
            "Type 'verifySession' to capture library exception throws and return the appropriate failure result instead of crashing the process."
        ],
        codeExample: `interface SessionPayload {\n  userId: string;\n  role: "admin" | "organizer" | "attendee";\n  expiresAt: number;\n}\n\ntype VerifyResult =\n  | { valid: true; session: SessionPayload }\n  | { valid: false; reason: string };\n\nfunction verifySession(token: string): VerifyResult {\n  try {\n    const payload = betterAuth.verifyJWT(token) as SessionPayload;\n    return { valid: true, session: payload };\n  } catch (err) {\n    return { valid: false, reason: \"Invalid or expired token\" };\n  }\n}`,
        codeTip: "Transforming runtime library errors into explicit typed algebraic results is the best way to handle auth boundary logic."
    },
    "level-8-5-async-handler": {
        explanation: "By default, Express v4 cannot catch promise rejections originating from within asynchronous route handlers. An 'asyncHandler' higher-order wrapper takes an async handler, runs it, and automatically routes any promise rejection to Express's global error middleware via 'catch(next)'.",
        steps: [
            "Declare 'asyncHandler' with a generic parameter '<Req extends Request = Request>'.",
            "Type the input handler callback 'fn' to take 'Req', 'Response', 'NextFunction', and return a Promise.",
            "Annotate the wrapper to return 'RequestHandler' and invoke '.catch(next)' on the wrapped handler promise."
        ],
        codeExample: `import { Request, Response, NextFunction, RequestHandler } from "express";\n\nfunction asyncHandler<Req extends Request = Request>(\n  fn: (req: Req, res: Response, next: NextFunction) => Promise<void>\n): RequestHandler {\n  return (req, res, next) => {\n    fn(req as Req, res, next).catch(next);\n  };\n}`,
        codeTip: "The generic parameter allows routes with customized body or param specifications (like Express Request overrides) to wrap seamlessly while keeping their types intact."
    },
    "level-8-6-checkpoint-booking-route": {
        explanation: "This backend checkpoint combines express routing generics, native MongoDB queries, declaration merging (user checks), and the generic asyncHandler wrapper to establish a complete production booking endpoint.",
        steps: [
            "Define 'BookingRequestBody' to specify the event identifier shape.",
            "Instantiate 'asyncHandler' and override the generic 'Request' type with body parameters: 'Request<{}, unknown, BookingRequestBody>'.",
            "Perform a database collection query casting the string parameter to an ObjectId.",
            "Enforce explicit null and authentication guards, returning structured success or error JSON objects."
        ],
        codeExample: `interface BookingRequestBody {\n  eventId: string;\n}\n\napp.post(\n  \"/bookings\",\n  asyncHandler<Request<{}, unknown, BookingRequestBody>>(async (req, res) => {\n    const event = await eventsCollection.findOne({ _id: new ObjectId(req.body.eventId) });\n    if (!event) {\n      res.status(404).json({ success: false, error: \"Event not found\" });\n      return;\n    }\n    if (!req.user) {\n      res.status(401).json({ success: false, error: \"Not authenticated\" });\n      return;\n    }\n    const booking = { eventId: req.body.eventId, userId: req.user.id };\n    res.json({ success: true, data: booking });\n  })\n);`,
        codeTip: "Using explicit return statements inside route branches avoids sending dual headers if multiple code paths are executed."
    },
    "level-8-7-runtime-validation": {
        explanation: "Static casts like 'as BookingRequestBody' do not perform any runtime validation of untrusted inputs. By writing a Zod schema and utilizing 'z.infer', you get both perfect runtime schema assertions and automatic TypeScript static type derivations with zero duplication.",
        steps: [
            "Define BookingSchema with z.object containing string eventId and positive slots.",
            "Derive BookingInput static type by querying BookingSchema with z.infer.",
            "In processRequest, invoke BookingSchema.safeParse on the raw body input to run runtime validations safely."
        ],
        codeExample: `import { z } from "zod";\n\nconst BookingSchema = z.object({\n  eventId: z.string(),\n  slots: z.number().positive(),\n});\n\ntype BookingInput = z.infer<typeof BookingSchema>;\n\nfunction processRequest(rawBody: unknown) {\n  return BookingSchema.safeParse(rawBody);\n}`,
        codeTip: "Using safeParse instead of parse ensures that validation failures return a structured error result instead of throwing unhandled exceptions that can crash your backend process."
    },
    // STAGE 9 — TYPE SAFETY MASTERY
    "level-9-1-branded-types": {
        explanation: "Nominal typing (Branding) is a pattern that forces the compiler to treat structurally identical primitives as entirely distinct types. By intersecting 'string' with an object containing a unique readonly '__brand' marker, we prevent UserId from being passed to parameters expecting EventId.",
        steps: [
            "Define 'EventId' and 'UserId' as branded types using an intersection: 'string & { readonly __brand: \"EventId\" }'.",
            "Create type casting helper functions 'toEventId' and 'toUserId' to safely map plain strings to these nominal branded types.",
            "Update parameter types in 'getEventById' and 'getUserById' to require their respective branded type."
        ],
        codeExample: `type EventId = string & { readonly __brand: "EventId" };\ntype UserId = string & { readonly __brand: "UserId" };\n\nfunction toEventId(id: string): EventId {\n  return id as EventId;\n}\n\nfunction toUserId(id: string): UserId {\n  return id as UserId;\n}\n\nfunction getEventById(id: EventId) {\n  // ...\n}\n\nfunction getUserById(id: UserId) {\n  // ...\n}\n\nconst someUserId = toUserId("user_123");\ngetEventById(someUserId);`,
        codeTip: "Because the brand marker property does not actually exist on the compiled JS string, branding is 100% free at runtime!"
    },
    "level-9-2-deep-readonly": {
        explanation: "The standard 'Readonly<T>' utility type is shallow, meaning it only locks the first level of an object's properties. To prevent deep modification of nested objects, we construct a recursive mapped type 'DeepReadonly<T>' that uses conditional types to traverse nested object shapes.",
        steps: [
            "Create a mapped type 'DeepReadonly<T>'.",
            "For each property 'P in keyof T', check if the value type 'T[P]' is an object.",
            "If it extends 'object', recursively invoke 'DeepReadonly<T[P]>', otherwise return the primitive 'T[P]' as-is."
        ],
        codeExample: `type DeepReadonly<T> = {\n  readonly [P in keyof T]: T[P] extends object ? DeepReadonly<T[P]> : T[P];\n};\n\nconst publishedEvent: DeepReadonly<Event> = getEvent();\npublishedEvent.venue.address = "Somewhere else";`,
        codeTip: "Using recursive self-referential structures inside mapped declarations is the standard way to implement system-wide state lockouts."
    },
    "level-9-3-algebraic-state-machines": {
        explanation: "Modeling state engines with Discriminated Unions lets you guarantee compile-time validity. By grouping mutually exclusive states with only their permitted parameters, illegal transition calls like confirming a cancelled booking are flagged directly by the compiler.",
        steps: [
            "Define 'Booking' as a discriminated union containing separate object states for 'pending', 'confirmed', and 'cancelled'.",
            "Ensure unique properties like 'paymentId' and 'cancelledReason' are only present on their corresponding state object.",
            "Use 'Extract<Booking, { status: \"pending\" }>' to constrain 'confirmBooking' parameters to ONLY accept a pending booking."
        ],
        codeExample: `type Booking =\n  | { status: "pending" }\n  | { status: "confirmed"; paymentId: string }\n  | { status: "cancelled"; cancelledReason: string };\n\nfunction confirmBooking(booking: Extract<Booking, { status: "pending" }>, paymentId: string): Booking {\n  return { status: "confirmed", paymentId };\n}`,
        codeTip: "Using 'Extract' on union members is cleaner and more scalable than manually writing individual state parameters."
    }
};
}),
"[project]/src/components/LevelDetailsPage.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/curriculum.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$solutions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/data/solutions.ts [app-ssr] (ecmascript)");
;
;
;
;
...
const LevelDetailsPage = ({ levelId, onSelectLevelId, unlockedLevelIds, setUnlockedLevelIds, onXpAwarded, onBadgeUnlocked, onBackToHome })=>{
    const level = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"].find((l)=>l.id === levelId) || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"][0];
    const stage = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STAGES"].find((s)=>s.levelIds.includes(level.id));
    const solDetails = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$solutions$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVEL_SOLUTIONS"][level.id];
    ...
    const totalCount = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"].length;
    const progressPercent = Math.round(completedCount / totalCount * 100);
    // Modal states
    const [showStoryModal, setShowStoryModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    const [activeFile, setActiveFile] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(level.playground.filesToEdit[0] || "index.ts");
    ...
    const [validationStatus, setValidationStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("idle");
    ...
    const [objectivesChecked, setObjectivesChecked] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const runValidationRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useRef(()=>{});
    ...
    const resetCodeToStarter = ()=>{
        ...
        setTerminalLogs((prev)=>[
                ...prev,
                `[info] Reset code back to initial template.`
            ]);
    };
    const runValidation = ()=>{
        ...
        setTerminalLogs((prev)=>[
                ...prev,
                `[compiler] Evaluating ${activeFile}...`
            ]);
        const errors = [];
        ...
        if (errors.length > 0) {
            ...
            const updatedList = completedList.includes(level.id) ? completedList : [
                ...completedList,
                level.id
            ];
            ...
            const currentIdx = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"].findIndex((l)=>l.id === level.id);
            if (currentIdx !== -1 && currentIdx + 1 < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"].length) {
                const nextLevelId = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"][currentIdx + 1].id;
    ...
    const handleNextLevel = ()=>{
        ...
        const currentIdx = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"].findIndex((l)=>l.id === level.id);
        if (currentIdx !== -1 && currentIdx + 1 < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"].length) {
            const nextLevel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$curriculum$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LEVELS"][currentIdx + 1];
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    children: [
                        isTerminal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                            lineNumber: 304,
                            columnNumber: 28
                        }, ("TURBOPACK compile-time value", void 0)),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            children: isTerminal ? codeContent.replace(">_", "").trim() : codeContent
                        }, void 0, false, {
                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                            lineNumber: 305,
                            columnNumber: 13
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "min-h-screen bg-surface text-on-surface flex flex-col font-sans",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                className: "bg-surface-container border-b border-outline-variant/30 shadow-md",
                children: [
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                        className: "text-xl md:text-2xl font-extrabold tracking-tight vibrant-gradient font-sans",
                                        children: "TypeScript Learning Game"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                        lineNumber: 333,
                                        columnNumber: 13
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-xs font-mono font-bold text-primary bg-primary/10 px-2.5 py-0.5 rounded-lg border border-primary/20 hidden sm:inline",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center space-x-1.5 bg-tertiary/10 border border-tertiary/30 px-3 py-1.5 rounded-xl text-tertiary font-bold text-xs",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$zap$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Zap$3e$__["Zap"], {
                                                className: "w-3.5 h-3.5 fill-tertiary"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                lineNumber: 355,
                                                columnNumber: 15
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "pb-3 px-6 flex flex-col items-center gap-1.5",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "w-full max-w-[80%] flex items-center gap-3 text-xs font-mono text-on-surface-variant",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center gap-1.5 text-secondary font-bold shrink-0",
                                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex-1 h-2 bg-surface-container-low rounded-full overflow-hidden border border-outline-variant/30",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-[11px] text-on-surface-variant/60 font-sans",
                                children: [
                                    "Now playing: ",
            ...
            showStoryModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-md animate-fadeIn",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "relative w-full max-w-3xl bg-surface-container border border-outline-variant/40 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh] glow-primary",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "p-6 bg-surface-container-low border-b border-outline-variant/30 flex items-center justify-between",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                            className: "text-xl font-extrabold text-on-surface tracking-tight font-sans",
                                            children: level.story.title || level.title
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                            lineNumber: 390,
                                            columnNumber: 17
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                            ...
                                            className: `text-xs font-mono font-bold px-3 py-1.5 rounded-xl border transition-colors cursor-pointer ${advancedMode ? "bg-secondary/20 text-secondary border-secondary/50" : "bg-surface-container-high text-on-surface-variant border-outline-variant/40"}`,
                                            children: [
                                                "<> Advanced Mode (",
                                                advancedMode ? "On" : "Off",
                                                ")"
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "p-6 md:p-8 overflow-y-auto flex-1 space-y-6 text-on-surface-variant text-sm leading-relaxed",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-4 font-sans text-sm md:text-base leading-relaxed",
                                    children: level.story.narrative.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-on-surface",
                                            children: renderFormattedText(item.text)
                                        }, idx, false, {
                                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                            lineNumber: 428,
                                            columnNumber: 19
                                ...
                                level.story.realWorldContext && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "p-5 rounded-2xl bg-surface-container-low border border-outline-variant/30 space-y-2 shadow-inner",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                            className: "text-xs font-mono font-bold uppercase tracking-wider text-secondary",
                                            children: "Real-World Context"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                            lineNumber: 437,
                                            columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: renderFormattedText(level.story.realWorldContext)
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                            lineNumber: 440,
                                            columnNumber: 19
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs md:text-sm text-on-surface leading-relaxed font-semibold",
                                            children: renderFormattedText(level.story.taskDescription)
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                            lineNumber: 451,
                                            columnNumber: 17
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "p-6 bg-surface-container-low border-t border-outline-variant/30 flex items-center justify-end",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "px-2 py-0.5 bg-neutral-950/10 rounded text-[10px] font-mono text-neutral-950/80",
                                        children: "(Ctrl+Enter)"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                        lineNumber: 467,
            ...
            showCompletionModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/85 backdrop-blur-md animate-fadeIn",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "p-8 bg-surface-container border border-outline-variant/40 rounded-2xl max-w-md w-full flex flex-col items-center text-center gap-5 shadow-2xl glow-primary relative",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "w-16 h-16 rounded-2xl bg-primary/10 border border-primary/30 flex items-center justify-center text-primary shadow-[0_0_20px_rgba(164,201,255,0.25)]",
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle2$3e$__["CheckCircle2"], {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                    className: "text-2xl font-extrabold text-on-surface font-sans",
                                    children: "Level Completed!"
                                }, void 0, false, {
                                    fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                    lineNumber: 495,
                                    columnNumber: 15
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: [
                                        "Great job! You mastered the type definitions for ",
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex items-center justify-center space-x-2 bg-tertiary/10 border border-tertiary/30 px-4 py-2 rounded-xl text-tertiary font-bold text-sm w-full",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$zap$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Zap$3e$__["Zap"], {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex items-center space-x-3 w-full pt-2",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: ()=>setShowCompletionModal(false),
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                className: "flex-1 grid grid-cols-1 lg:grid-cols-12 gap-0 min-h-0 overflow-y-auto lg:overflow-hidden",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                        className: "lg:col-span-4 bg-surface-container-low border-b lg:border-b-0 lg:border-r border-outline-variant/30 p-4 md:p-6 overflow-y-auto space-y-5 md:space-y-6 flex flex-col",
                        children: [
                            level.playground.filesToEdit && level.playground.filesToEdit.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-2",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-[10px] font-mono font-bold uppercase tracking-wider text-primary",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: level.playground.filesToEdit.map((file, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>{
                                                    playChime("click");
                                                    setActiveFile(file);
                                                },
                                                className: `flex items-center space-x-2 px-3 py-1.5 rounded-lg text-xs font-mono transition-colors cursor-pointer border ${activeFile === file ? "bg-primary/10 border-primary/40 text-primary font-bold" : "bg-surface-container border-outline-variant/30 text-on-surface-variant hover:text-on-surface"}`,
                                                children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-3 p-5 rounded-2xl bg-surface-container border border-outline-variant/30 shadow-sm",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center justify-between",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h4", {
                                                className: "text-xs font-mono font-bold uppercase tracking-wider text-on-surface",
                                                children: "Target Objectives"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                lineNumber: 563,
                                                columnNumber: 15
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-[10px] font-mono font-bold text-secondary",
                                                children: [
                                                    objectivesChecked.filter(Boolean).length,
                                                    "/",
                                                    level.playground.objectives.length,
                                                    " Done"
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                        ...
                                        children: level.playground.objectives.map((obj, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                className: "flex items-start space-x-2.5 text-xs text-on-surface-variant",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: `mt-0.5 w-4 h-4 rounded flex items-center justify-center shrink-0 border ${objectivesChecked[i] ? "bg-emerald-500/20 border-emerald-500/50 text-emerald-400" : "border-outline-variant bg-surface-container-low"}`,
                                                        children: objectivesChecked[i] && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__["Check"], {
                                                            className: "w-3 h-3"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                            lineNumber: 580,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: objectivesChecked[i] ? "line-through text-on-surface-variant/60" : "text-on-surface",
                                                        children: obj
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                        lineNumber: 582,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "space-y-3 mt-auto pt-4 border-t border-outline-variant/30",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        children: showHints ? "Hide Guided Hints" : "Guided Hints"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                        lineNumber: 601,
                                                        columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: showSolution ? "Hide Solution" : "Solution & Explanation"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                lineNumber: 604,
                                                columnNumber: 15
                                    ...
                                    showHints && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "p-4 rounded-xl bg-surface-container border border-tertiary/20 text-xs text-on-surface-variant space-y-2",
                                        children: level.playground.hints.map((hint, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    showSolution && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "p-5 rounded-2xl bg-surface-container border border-outline-variant/40 space-y-4 text-xs",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-1",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-mono text-[10px] font-bold uppercase tracking-wider text-emerald-400 block",
                                                        children: "Detailed Solution Explanation"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                        lineNumber: 629,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: solDetails?.explanation || "This solution demonstrates clean type declarations following strict compiler requirements."
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                        lineNumber: 632,
                                                        columnNumber: 19
                                            ...
                                            solDetails?.steps && solDetails.steps.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "space-y-1.5",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-mono text-[10px] font-bold uppercase tracking-wider text-secondary block",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ol", {
                                                        className: "list-decimal list-inside space-y-1 text-on-surface-variant/90 pl-1",
                                                        children: solDetails.steps.map((step, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                                                className: "leading-relaxed",
                                                                children: step
                                                            }, idx, false, {
                                                                fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                            ...
                                            solDetails?.codeTip && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "p-3 rounded-xl bg-surface-container-low border border-tertiary/30 text-tertiary text-[11px] leading-relaxed",
                                                children: [
                                                    "💡 ",
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                        children: "Pro Tip:"
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "font-mono text-[10px] font-bold uppercase tracking-wider text-primary block",
                                                        children: "Reference Code Snippet"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                        lineNumber: 657,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                                                        className: "p-3.5 rounded-xl bg-surface-container-lowest border border-outline-variant/30 text-emerald-400 font-mono text-xs overflow-x-auto",
                                                        children: level.playground.solutionCode
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                        lineNumber: 660,
                                                        columnNumber: 19
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        className: "lg:col-span-8 flex flex-col min-h-[450px] lg:min-h-0 bg-surface",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "h-10 bg-surface-container-low border-b border-outline-variant/30 px-4 flex items-center justify-between text-xs",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center space-x-3",
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "font-mono text-primary font-bold flex items-center gap-2",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            ...
                                            validationStatus === "success" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "text-[10px] font-mono font-bold text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/30",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$play$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Play$3e$__["Play"], {
                                                        className: "w-3.5 h-3.5 fill-neutral-950"
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                        lineNumber: 698,
                                                        columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$monaco$2d$editor$2f$react$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
                                    height: "100%",
                                    language: activeFile.endsWith(".json") ? "json" : activeFile.endsWith(".md") ? "markdown" : "typescript",
                                    theme: "vs-dark",
                                    value: userCode,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "h-44 bg-surface-container-lowest border-t border-outline-variant/30 p-4 font-mono text-xs overflow-y-auto space-y-1",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex items-center space-x-2 text-on-surface-variant mb-2 pb-1 border-b border-outline-variant/20",
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: "font-bold uppercase tracking-wider text-[10px] text-primary",
                                                children: "Compiler Output Terminal"
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                                lineNumber: 734,
                                                columnNumber: 15
                                    ...
                                    terminalLogs.map((log, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: log.includes("❌") ? "text-rose-400 font-semibold" : log.includes("✅") ? "text-emerald-400 font-bold" : "text-on-surface-variant",
                                            children: log
                                        }, i, false, {
                                            fileName: "[project]/src/components/LevelDetailsPage.tsx",
                                            lineNumber: 740,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$cc96d03b$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__b9__as__initializeFirestore$3e$__ = __turbopack_context__.i("[project]/node_modules/@firebase/firestore/dist/common-cc96d03b.node.mjs [app-ssr] (ecmascript) <export b9 as initializeFirestore>");
...
const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$cc96d03b$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__b9__as__initializeFirestore$3e$__["initializeFirestore"])(app, {}, __TURBOPACK__imported__module__$5b$project$5d2f$firebase$2d$applet$2d$config$2e$json$2e5b$json$5d2e$cjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].firestoreDatabaseId || "(default)");
async function saveWizardProgress(userId, progress) {
    const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$cc96d03b$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__aa__as__doc$3e$__["doc"])(db, "wizards", userId);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["setDoc"])(userDocRef, progress, {
        merge: true
    });
}
async function getWizardProgress(userId) {
    const userDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$common$2d$cc96d03b$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__aa__as__doc$3e$__["doc"])(db, "wizards", userId);
    const snap = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getDoc"])(userDocRef);
    if (snap.exists()) {
        return snap.data();
    }
    return null;
...
async function saveLevelCodeCloud(userId, levelId, code) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["updateDoc"])(userDocRef, {
        [fieldPath]: code
    });
}
;
}),
"[project]/src/components/WizardSanctum.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$auth$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/auth/dist/index.mjs [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$65577477$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__ab__as__createUserWithEmailAndPassword$3e$__ = __turbopack_context__.i("[project]/node_modules/@firebase/auth/dist/node-esm/totp-65577477.js [app-ssr] (ecmascript) <export ab as createUserWithEmailAndPassword>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$65577477$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__al__as__updateProfile$3e$__ = __turbopack_context__.i("[project]/node_modules/@firebase/auth/dist/node-esm/totp-65577477.js [app-ssr] (ecmascript) <export al as updateProfile>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$sparkles$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Sparkles$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/sparkles.js [app-ssr] (ecmascript) <export default as Sparkles>");
...
function WizardSanctum({ isOpen, onClose, xp, unlockedBadges, unlockedLevels, onAuthSuccess, onSignOut }) {
    ...
    const [wizardTitle, setWizardTitle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(WIZARD_TITLES[0]);
    ...
    const handleRegister = async (e)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$totp$2d$65577477$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__al__as__updateProfile$3e$__["updateProfile"])(credential.user, {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["saveWizardProgress"])(credential.user.uid, initialProgress);
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        currentUser ? /* Logged In view */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-6",
                            ...
                            lineNumber: 286,
                            columnNumber: 13
                        }, this) : /* Auth Forms */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-5",
                            ...
                            children: [
                                ...
                                activeTab === "signin" ? /* SIGN IN FORM */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                            ...
                                                            children: WIZARD_TITLES.map((t)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                    value: t,
...
const GameProvider = ({ children })=>{
    ...
    const [unlockedBadges, setUnlockedBadges] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const [unlockedLevelIds, setUnlockedLevelIds] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([
        "level-0-1-bootstrap"
    ]);
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [wizardTitle, setWizardTitle] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("Primitive Initiate");
    const [isSanctumOpen, setIsSanctumOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const [showCelebration, setShowCelebration] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
    ...
    const handleUserLogin = async (uid)=>{
        try {
            const cloudProgress = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWizardProgress"])(uid);
            if (cloudProgress) {
...
"[project]/src/app/level/[id]/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LevelDetailsPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/LevelDetailsPage.tsx [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$WizardSanctum$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/WizardSanctum.tsx [app-ssr] (ecmascript)");
...
;
;
function LevelPageContent({ levelId }) {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const { xp, unlockedLevelIds, setUnlockedLevelIds, unlockedBadges, user, isSanctumOpen, setIsSanctumOpen, handleXpAwarded, handleBadgeUnlocked, handleSignOut } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$GameContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGame"])();
    const handleSelectLevelId = (nextId)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$Navigation$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                ...
                fileName: "[project]/src/app/level/[id]/page.tsx",
                lineNumber: 37,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$LevelDetailsPage$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["LevelDetailsPage"], {
                levelId: levelId,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$WizardSanctum$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
...
function LevelPage({ params }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$GameContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GameProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(LevelPageContent, {
            levelId: levelId
        }, void 0, false, {
            fileName: "[project]/src/app/level/[id]/page.tsx",
            lineNumber: 83,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0f0sp99._.js.map